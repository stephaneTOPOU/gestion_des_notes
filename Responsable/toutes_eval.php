                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="devoir" data-editable="false">Type</th>
                                                <th data-field="name" data-editable="false">Matière</th>
                                                <th data-field="email" data-editable="false">Crédit</th>
												<th data-field="partiel" data-editable="false">Date</th>
												<th data-field="moyenne" data-editable="false">Semestre</th>
                                                <th data-field="action">Notée ?</th>
												<th data-field="dc">Action ...</th>
                                            </tr>
                                        </thead>
                                        <tbody>
										<?php
										$nbr=0;
										$reponse = $bdd->query('SELECT M.codemat, M.libellemat, M.nbr_credi,E.ideval,E.date_eval,E.eval_noter,M.libellemat, S.libellesem,Si.libelle FROM matiere M, evaluation E,semestre S, SESSION Si WHERE Si.idsess=E.idsess AND M.codemat = E.codemat AND E.idsem=S.idsem AND S.idan=(\''.$_GET['annee'].'\') AND M.idens=(\''.$_SESSION['pseudo'].'\') ORDER BY E.date_eval DESC');
											while ($donnee = $reponse->fetch()) { $nbr=($nbr+1);?>
												<tr>
													<td><?php echo($nbr); ?></td>
													<td><?php echo($donnee['libelle']); ?></td>
													<td><?php echo($donnee['libellemat']); ?></td>
													<td><?php echo($donnee['nbr_credi']); ?></td>
													<td><?php echo($donnee['date_eval']); ?></td>
													<td><?php echo($donnee['libellesem']); ?></td>
													<?php
													$valider='fa-check';
													if($donnee['eval_noter']==null){
														$valider='fa-times';
													} ?>
													<td class="datatable-ct"><i class="fa <?php echo($valider); ?>"></i></td>
													<td><a href="noter_evaluation.php?evaluation=<?php echo($donnee['ideval']); ?>&lib=<?php echo($donnee['libellemat']); ?>&typev=<?php echo($donnee['libelle']); ?>&date=<?php echo($donnee['date_eval']); ?>"><b>Cliquez pour noter</b></a></td>
												</tr>
										<?php } ?>
                                        </tbody>
                                    </table>
